...
import com.fxsd.framwork.mq.Message;
import com.fxsd.framwork.mq.MessageChannel;
import com.fxsd.framwork.mq.MessageListener;
import com.fxsd.framwork.mq.MessageListenerContainer;
 ...
 * @version 1.0
 */
public class OnsMessageListenerContainer implements InitializingBean, DisposableBean , ApplicationContextAware, MessageListenerContainer {

	private final static Log logger = LogFactory.getLog(OnsMessageListenerContainer.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		producer = applicationContext.getBean(OnsMessageProducer.class);
