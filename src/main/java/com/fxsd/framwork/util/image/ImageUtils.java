package com.fxsd.framwork.util.image;
...
import com.fxsd.framwork.util.DataUtils;
...
public class ImageUtils {
	 ...
	 * 
	 * @param negativeImage 背景图片
	 * @param additionImage 附加图片路径
	 * @param x 附加图片的起始点x坐标
	 * @param y 附加图片的起始点y坐标
	 */
	...
	/**
	 * 横向拼接图片（两张）
	 * @param firstSrcImage       第一张图片的路径
	 * @param secondSrcImage      第二张图片的路径
	 ...
	 * @throws Exception 
	 */
	public static File joinImagesHorizontal(URL firstSrcImage, URL secondSrcImage, String imageFormat) throws Exception {
